...
public abstract class SnowFoxArmorItem extends ArmorItem {
	public SnowFoxArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends SnowFoxArmorItem {
		public Helmet() {
