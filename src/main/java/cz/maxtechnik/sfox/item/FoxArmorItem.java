...
public abstract class FoxArmorItem extends ArmorItem {
	public FoxArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends FoxArmorItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("\u00A77(hat)"));
		}
